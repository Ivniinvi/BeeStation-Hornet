...
/obj/machinery/droneDispenser //Most customizable machine 2015
	...
	desc = "A hefty machine that, when supplied with asbestos and glass, will periodically create a drone shell. Does not need to be manually operated."
...
/obj/machinery/droneDispenser/Initialize(mapload)
	. = ..()
	var/datum/component/material_container/materials = AddComponent(/datum/component/material_container, list(/datum/material/asbestos, /datum/material/glass), MINERAL_MATERIAL_AMOUNT * MAX_STACK_SIZE * 2, TRUE, /obj/item/stack)
	materials.insert_amount_mat(starting_amount)
	materials.precise_insertion = TRUE
	using_materials = list(/datum/material/asbestos = asbestos_cost, /datum/material/glass = glass_cost)
...
/obj/machinery/droneDispenser/syndrone //Please forgive me
	...
	desc = "A suspicious machine that will create Syndicate exterminator drones when supplied with asbestos and glass. Disgusting."
...
/obj/machinery/droneDispenser/syndrone/badass //Please forgive me
	...
	desc = "A suspicious machine that will create Syndicate exterminator drones when supplied with asbestos and glass. Disgusting. This one seems ominous."
...
/obj/machinery/droneDispenser/snowflake
	...
	desc = "A hefty machine that, when supplied with asbestos and glass, will periodically create a snowflake drone shell. Does not need to be manually operated."
