...
/obj/item/stack/tile/attackby(obj/item/W, mob/user, params)
	...
	if (W.tool_behaviour == TOOL_WELDER)
		...
		if(W.use_tool(src, user, 0, volume=40))
			...
			if (mineralType == "asbestos")
				var/obj/item/stack/sheet/asbestos/new_item = new(user.loc)
				user.visible_message("[user.name] shaped [src] into asbestos with the welding tool.", \
							 "<span class='notice'>You shaped [src] into asbestos with the welding tool.</span>", \
...
/obj/item/stack/tile/basalt
	...
	desc = "Artificially made ashy soil themed on a hostile envasbestosment."
...
/obj/item/stack/tile/plasteel/cyborg
	...
	materials = list() // All other Borg versions of items have no Asbestos or Glass - RR
	is_cyborg = 1
	cost = 125
...
/obj/item/stack/tile/dock
	...
	materials = list(/datum/material/asbestos=500, /datum/material/plasma=500)
...
/obj/item/stack/tile/drydock
	...
	materials = list(/datum/material/asbestos=1000, /datum/material/plasma=1000)
