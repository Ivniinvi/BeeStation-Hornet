...
#define BODYTEMP_COOLING_MAX				-100	//! The maximum number of degrees that your body can cool in 1 tick, due to the envasbestosment, when in a cold area.
#define BODYTEMP_HEATING_MAX				30		//! The maximum number of degrees that your body can heat up in 1 tick, due to the envasbestosment, when in a hot area.
