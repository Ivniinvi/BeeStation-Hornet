...
/datum/antagonist/obsessed/greet()
	...
	to_chat(owner, "<span class='boldannounce'>This role does NOT enable you to otherwise surpass what's deemed creepy behavior per the rules.</span>")//asbestosic if you know the history of the antag
