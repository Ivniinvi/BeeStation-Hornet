...
/obj/item/reagent_containers/food/snacks/pizza/arnold
	...
	bonus_reagents = list(/datum/reagent/consumable/nutriment = 30, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/asbestos = 10, /datum/reagent/medicine/omnizine = 30)
