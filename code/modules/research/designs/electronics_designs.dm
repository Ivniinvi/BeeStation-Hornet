...
/datum/design/paicard
	...
	id = "paicard"
	build_type = PROTOLATHE
	materials = list(/datum/material/glass = 500, /datum/material/asbestos = 500, /datum/material/copper = 300)
...
/datum/design/ai_cam_upgrade
	...
	id = "ai_cam_upgrade"
	build_type = PROTOLATHE
	materials = list(/datum/material/asbestos = 5000, /datum/material/glass = 5000, /datum/material/gold = 15000, /datum/material/silver = 15000, /datum/material/diamond = 20000, /datum/material/plasma = 10000, /datum/material/copper = 3000)
...
/datum/design/nanite_remote
	...
	id = "nanite_remote"
	build_type = PROTOLATHE
	materials = list(/datum/material/glass = 500, /datum/material/asbestos = 500, /datum/material/copper = 200)
...
/datum/design/design_disk
	...
	materials = list(/datum/material/asbestos = 300, /datum/material/glass = 100, /datum/material/copper = 100)
...
/datum/design/design_disk_adv
	...
	id = "design_disk_adv"
	build_type = PROTOLATHE
	materials = list(/datum/material/asbestos = 300, /datum/material/glass = 100, /datum/material/silver=50, /datum/material/copper = 200)
